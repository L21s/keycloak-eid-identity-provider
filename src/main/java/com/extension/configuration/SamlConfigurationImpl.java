...
public class SamlConfigurationImpl implements SamlConfiguration {
    ...
    public SamlConfigurationImpl(Map<String, String> config, String responseReceiverRealm) {
        this.samlKeyMaterial = new SamlKeyMaterialImpl(
        ...
        this.samlEidServerConfiguration = new SamlEidServerConfigurationImpl(config.get(EidIdentityProviderModel.ID_PANSTAR_SERVER_URL));
        this.samlServiceProviderConfiguration = new SamlServiceProviderConfigurationImpl(
                responseReceiverRealm,
                config.get(EidIdentityProviderModel.SAML_ENTITY_BASE_URL)
        );
    }
