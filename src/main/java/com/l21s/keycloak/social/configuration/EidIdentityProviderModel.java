...
public class EidIdentityProviderModel extends IdentityProviderModel {
  ...
  public static final String SAML_RESPONSE_DECRYPRION_PUBLIC_KEY =
      "samlResponseDecryptionPublicKey";
  public static final String SAML_RESPONSE_DECRYPRION_PRIVATE_KEY =
      "samlResponseDecryptionPrivateKey";
  public static final String SAML_RESPONSE_VERIFICATION_CERTIFICATE =
      "samlResponseVerificationCertificate";
  public static final String SAML_REQUEST_ENCRYPTION_CERTIFICATE =
